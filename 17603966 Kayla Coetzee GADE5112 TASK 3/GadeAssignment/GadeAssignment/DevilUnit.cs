...
{
    class DevilUnit: Unit
    {

        private const int INSTANTDAMAGE = 15;

        //constructors

        public DevilUnit(int x, int y, int health, int speed, bool attack, int attackRange, string faction, string symbol, string name)
        ...
        public override void save()
        {
            ...
            {
                //open file
                outFile = new FileStream(@"Files\devilunit.txt", FileMode.Create, FileAccess.Write);
