...
namespace GadeAssignment
{
    class SpyUnit: Unit
    {
        private const int SPEEDDAMAGE = 2;

        //constructors

        public SpyUnit(int x, int y, int health, int speed, bool attack, int attackRange, string faction, string symbol, string name)
        ...
        public override void save()
        {
            ...
            {
                //open file
                outFile = new FileStream(@"Files\spyunit.txt", FileMode.Create, FileAccess.Write);
