...
{
    class ThiefUnit: Unit
    {
        private const int DAMAGE = 1;

        //constructors

        public ThiefUnit(int x, int y, int health, int speed, bool attack, int attackRange, string faction, string symbol, string name)
        ...
        public override void save()
        {
            ...
            {
                //open file
                outFile = new FileStream(@"Files\thiefunit.txt", FileMode.Create, FileAccess.Write);
